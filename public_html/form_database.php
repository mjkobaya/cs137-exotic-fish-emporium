    ...
    background-attachment: fixed;
      ...
      <section style="font-family:Arial, Helvetica, sans-serif;" id="top-navbar">
         <ul style="position:relative;bottom:5px;font-size:110%;padding:default">
            ...
            <li style="margin:0;padding:5px 15px 0px 15px; display:inline; width:5em;float:right"id="logo-img-li" ><a style="width:120%;"href="home.html"><img class="rotate" style="height:0%;" id="logo-img" src="img/fish-logo.png"/></a></li>
            <li class="right">
