         ...
         <tr style="background-color:rgba(0, 255, 0, 0)">
            <td >
               <div class="w3-content w3-display-container" style="max-width:600px;background-color:rgba(0, 255, 0, 0)">
                  <img class="mySlides" src="img/mushroom1.jpg" style="width:100%; height:400px">
                  <img class="mySlides" src="img/mushroom2.jpg" style="width:100%; height:400px">
                  <img class="mySlides" src="img/mushroom3.jpg" style="width:100%; height:400px">
            ...
            <?php
              ...
              $sql = "SELECT name, price, description FROM products WHERE pid = 15";
            ...
            <td>
               ...
               <div id="id01" class="w3-modal">
                  <div style="background-image: url("img/scale-light.png")" class="w3-modal-content w3-animate-top w3-card-8">
                     ...
                     <button type="submit" form="orderForm" style="font-size:150%;width:10%;background-color:#204060;position:relative;bottom:30px;left:450px;" onclick="validateForm('Mushroom');" class="w3-btn">Buy</button>  
