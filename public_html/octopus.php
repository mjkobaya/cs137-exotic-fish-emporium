...
<html>
   ...
   <head>
      ...
      <title>Fish Forever - Octopus</title>
      <meta charset="UTF-8">
         ...
         <tr style="background-color:rgba(0, 255, 0, 0)">
            <td >
               <div class="w3-content w3-display-container" style="max-width:600px;background-color:rgba(0, 255, 0, 0)">
                  <img class="mySlides" src="img/octopus4.jpg" style="width:100%; height:400px">
                  <img class="mySlides" src="img/octopus2.png" style="width:100%; height:400px">
                  <img class="mySlides" src="img/octopus3.png" style="width:100%; height:400px">
            ...
            <?php
              ...
              $sql = "SELECT name, price, description FROM products WHERE pid = 4";

              foreach ($conn->query($sql) as $row) {
                      echo '<p style="position: relative;bottom:20px;font-size: 300%;color:#DDE5F9;text-shadow: 2px 2px #000000">' . $row['name'] . '<br> <a style="position: relative;bottom:20px;font-size:30px"> Price: $70.95</a></p>';
            ...
            <td>
               ...
               <div id="id01" class="w3-modal">
                  <div style="background-image: url("img/scale-light.png")" class="w3-modal-content w3-animate-top w3-card-8">
                        ...
                        <form action="form_database.php" id="orderForm" name="form"  method="post">
                              ...
                              <tr>
                                 ...
                                 <td>
                                  ...
                                  <div type="price" id="price" value="70.95" > </div>
                                  <div style="font-size:150%;position:relative;bottom:20px;"type="total" id="total" >Total: $70.95 </div>
                     ...
                     <button type="submit" form="orderForm" style="font-size:150%;width:10%;background-color:#204060;position:relative;bottom:30px;left:450px;" onclick="validateForm('Octopus');" class="w3-btn">Buy</button>  
