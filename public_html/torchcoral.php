...
<html>
   ...
   <head>
      ...
      <title>Fish Forever - Torch Coral</title>
      <meta charset="UTF-8">
         ...
         <tr style="background-color:rgba(0, 255, 0, 0)">
            <td >
               <div class="w3-content w3-display-container" style="max-width:600px;background-color:rgba(0, 255, 0, 0)">
                  <img class="mySlides" src="img/torchcoral1.jpg" style="width:100%; height:400px">
                  <img class="mySlides" src="img/torchcoral2.jpg" style="width:100%; height:400px">
                  <img class="mySlides" src="img/torchcoral3.jpg" style="width:100%; height:400px">
            ...
            <td style="background-color:rgba(0, 255, 0, 0);vertical-align:top;width:400px">
                ...
                <?php
                  ...
                  $sql = "SELECT name, price, description FROM products WHERE pid = 7";
            ...
            <html>
               ...
               <!-- <p style="position: relative;bottom:20px;font-size: 300%;color:#DDE5F9;text-shadow: 2px 2px #000000">Torch Coral <br> <a style="position: relative;bottom:20px;font-size:30px"> Price: $68.95</a></p>
               <p style="position: relative;bottom:70px;font-size: 105%;color:#DDE5F9;text-shadow: 1px 1px #000000">The Euphyllia Torch Coral is a large polyp stony (LPS) coral, often referred to as Trumpet Coral or Pom-Pom Coral. It has long and flowing polyps with single rounded tips which are visible throughout the day and night, hiding its branching skeletal base most of the time. It may be brown or green with yellow on the tips of its tentacles. The yellow will sometimes appear to glow under actinic lighting.</p> -->
               ...
               <div id="id01" class="w3-modal">
                  <div style="background-image: url("img/scale-light.png")" class="w3-modal-content w3-animate-top w3-card-8">
                     ...
                     <div class="w3-container" style="color:black">
                      <table >
                        <form action="form_database.php" id="orderForm" name="form"  method="post" onsubmit="return validateForm('Torch Coral')">
                              ...
                              <tr>
                                 ...
                                 <td>
                                  ...
                                  <div type="price" id="price" value="68.95" > </div>
                                  <div style="font-size:150%;position:relative;bottom:20px;"type="total" id="total" >Total: $68.95 </div>
